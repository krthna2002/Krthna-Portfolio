...
const Projects = () => {
  const projects = [
    ...
    liveUrl: 'https://bloomtrack-herbal-plant-e-commerce-w5qu.onrender.com', 
    githubUrl: 'https://github.com/krthna2002/BloomTrack-Herbal-Plant-E-Commerce-Website.git'}, 
  //   {
